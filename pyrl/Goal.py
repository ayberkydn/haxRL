...
from config import post_radius

class Goal:
    def __init__(self, center_x, center_y, way, length):
        ...
        self.top_post = Disc(center_x, center_y - self.length / 2, post_radius, math.inf, 0.2, 0, Color.border)
        self.bottom_post = Disc(center_x, center_y + self.length / 2, post_radius, math.inf, 0.2, 0, Color.border)
